...
namespace Wolmart.Ecommerce.Migrations
{
    ...
    [Migration("20230628233522_UpdatedProductTableRelatedFeedbackImageTable")]
    partial class UpdatedProductTableRelatedFeedbackImageTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wolmart.Ecommerce.Models.AppUser", b =>
                {
                    ...
                    b.Property<string>("StreetAddrFirst")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<string>("StreetAddrSecond")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("Wolmart.Ecommerce.Models.Countries", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wolmart.Ecommerce.Models.Order", b =>
                {
                    ...
                    b.HasOne("Wolmart.Ecommerce.Models.Countries", "Countries")
                        .WithMany("Orders")
