$(document).ready(function () {
    ...
    //    //$(".search-body").addClass("d-block");
    //    //debugger;
    //    let searchotherpage = $(this).val().trim();
    ...
    //    url = url + '?searchotherpage=' + searchotherpage


    //    if (searchotherpage) {
    //        fetch(url).then(res => res.text()).then(data => {
    //            $('.product-wrapper .product-wrap').html(data);
    //            fetch('/product/SearchOtherPage').then(res => res.text())
    //                .then(data => {
    //                    $('.product-wrapper .product-wrap').html(data);
    //                });
    //        })
